...
public class Dashboard extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        messageBox("Success","Menu clicked");
       ...
       // EditText editText = (EditText) findViewById(R.id.editJournalDate);
