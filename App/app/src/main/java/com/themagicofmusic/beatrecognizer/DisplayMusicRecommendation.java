 ...
 */
public class DisplayMusicRecommendation extends AppCompatActivity {

    public final static String EXTRA_MESSAGE = "MESSAGE";
    private ListView obj;
    MusicRecommendationDBHelper mydb;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_display_music_recommendation);

        //Temp
        int personID= SelectedPerson.PersonID;
        try {
            mydb = new MusicRecommendationDBHelper(this);
            musicdb = new MusicDBHelper(this);
            List<MusicRecommendation> MusicRecommendationList = mydb.getAllMusicRecommendations(personID);
            ArrayList<String> MusicRecommendations = new ArrayList<String>();
            if(MusicRecommendationList.size() > 0)
            {
                for(MusicRecommendation Music : MusicRecommendationList)
                {
