...
public class GracenoteMusicID extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            messageBox("Call", "Calling OnCreate");
        createUI();
        ...
        if ( (gnsdkLicenseFilename == null) || (gnsdkLicenseFilename.length() == 0) ){
            ...
            if(e.getMessage() != null){
                ...
                messageBox("Error occured", "Error in GraceNoteMusicID "+ e.getMessage());
            }
            else{
                e.printStackTrace();
    ...
    private void createUI() {
        ...
        setContentView(R.layout.activity_grace_note);
